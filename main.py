...
os.system(f'title [Equilibrium Multi-Tool] - Connected')
...
def accountnuker():
  ...
  print(f'''
            ...
            {Fore.YELLOW}╚╝ ╚╝╚══╝╚══╝╚══╝╚══╝╚╝╚╝ ╚═╝    ╚╝╚╝╚══╝╚╝╚╝╚══╝╚╝ 
            {Fore.RED}[+]═════════════════════[+]═══════════════════[+]
            {Fore.RED} ║ {Fore.YELLOW}[1] - Remove Friends  {Fore.RED}║ {Fore.YELLOW}[4] - All In One    {Fore.RED}║
            {Fore.RED} ║ {Fore.YELLOW}[2] - Remove Guilds   {Fore.RED}║ {Fore.YELLOW}[5] - Scrape Info   {Fore.RED}║
            {Fore.RED} ║ {Fore.YELLOW}[3] - Spam Servers    {Fore.RED}║ {Fore.YELLOW}[6] - Back To Menu  {Fore.RED}║
            {Fore.RED}[+]═════════════════════[+]═══════════════════[+]
  ''')
...
def banall():
  ...
  os.system('cls; clear')
  print("EQUILIBRIUM - NUKER - ACTIVATING BAN PROCESS...")
...
def chandel():
  ...
  guild = input("\u001b[38;5;111mGuild ID: ")
  os.system('cls; clear')
  print("EQUILIBRIUM - NUKER - ACTIVATING CHANNEL DELETION PROCESS...")
...
def roledel():
  ...
  guild = input("\u001b[38;5;111mGuild ID: ")
  os.system('cls; clear')
  print("EQUILIBRIUM - NUKER - ACTIVATING ROLE DELETION PROCESS...")
...
def chanspam():
  ...
  amount = input("Amount: ")
  os.system('cls; clear')
  print("EQUILIBRIUM - NUKER - ACTIVATING CHANNEL CREATION PROCESS...")
  for i in range(int(amount)):
...
def rolespam():
  ...
  amount = input("Amount: ")
  os.system('cls; clear')
  print("EQUILIBRIUM - NUKER - ACTIVATING ROLE CREATION PROCESS...")
  for i in range(int(amount)):
...
def server():
  ...
  print(f'''{Fore.YELLOW} 
          ...
          {Fore.RED}[+]═════════════════════[+]═══════════════════[+]
           {Fore.RED}║ {Fore.YELLOW}[1] - Ban Members     {Fore.RED}║ {Fore.YELLOW}[5] - Spam Roles    {Fore.RED}║
           {Fore.RED}║ {Fore.YELLOW}[2] - Del Channels    {Fore.RED}║ {Fore.YELLOW}[6] - Nuke Server   {Fore.RED}║
           {Fore.RED}║ {Fore.YELLOW}[3] - Del Roles       {Fore.RED}║ {Fore.YELLOW}[7] - Scrape Info   {Fore.RED}║
           {Fore.RED}║ {Fore.YELLOW}[4] - Spam Channels   {Fore.RED}║ {Fore.YELLOW}[8] - Back To Menu  {Fore.RED}║
          {Fore.RED}[+]═════════════════════[+]═══════════════════[+]
  ...
  if choice == 1:
    ...
    roledel()
    os.system('cls; clear')
    print('NUKE - CONFIG SETTINGS - EQUILIBRIUM NUKER')
    chanspam()
    rolespam
    time.sleep(1)
    server()
...
def tokengen():
  os.system('cls; clear')
  print('[EQUILIBRIUM TOOLKIT] - TOKEN GENERATOR: \n')
  try:
...
def nitrogen():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - NITRO GENERATOR: \n')
    try:
      amount = int(input('Amount: '))
      print()
      value = 1
...
def deleter():
  os.system('cls; clear')
  print('[EQUILIBRIUM TOOLKIT] - WEBHOOK DELETION: \n')
  try:
...
def spammer():
  os.system('cls; clear')
  print('[EQUILIBRIUM TOOLKIT] - WEBHOOK SPAM: \n')
  try:
    webhook = input("Webhook: ")
...
def hypesquad():
    os.system('cls; clear')
    print("[EQUILIBRIUM TOOLKIT] - HYPESQUAD CHANGER: \n")
    print("""
[1] Bravery
[2] Brilliance
[3] Balance
...
def bantoken():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - DISABLE TOKEN: \n')
    token = input('Token: ')
    headers = {'Authorization': token, 'Content-Type': 'application/json'}  
    r = requests.get('https://discord.com/api/v8/users/@me', headers=headers)
    if r.status_code == 200:
...
def unverifytoken():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - UNVERIFY TOKEN: \n')
...
def tokenfromuserid():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - HALF TOKEN FROM USER ID: \n')
    userid = input('UserID: ')
...
def tokeninfo():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - TOKEN INFO: \n')
    token = input('Token: ')
    headers = {'Authorization': token, 'Content-Type': 'application/json'}  
    r = requests.get('https://discord.com/api/v8/users/@me', headers=headers)
    if r.status_code == 200:
...
def tokenfetcher():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - TOKEN FETCHER: \n')
    email = input('Email: ')
...
def trolltoken():
    os.system('cls; clear')
    print('[EQUILIBRIUM TOOLKIT] - TROLLING TOKEN: \n')
    token = input('Token: ')
    headers = {'Authorization': token, 'Content-Type': 'application/json'}
    amount = int(input('Amount: '))
    print()
...
def tool():
  ...
  print(f'''{Fore.YELLOW}
      ...
      {Fore.RED}[+]═══════════════════════════════[+]════════════════════════════════[+]
       {Fore.RED}║ {Fore.YELLOW}[1] - Token From Email;Pass     {Fore.RED}║ {Fore.YELLOW}[7] - Change Hypesquad House     {Fore.RED}║
       {Fore.RED}║ {Fore.YELLOW}[2] - Troll Token / Cycle       {Fore.RED}║ {Fore.YELLOW}[8] - Spam Given Webhook         {Fore.RED}║
       {Fore.RED}║ {Fore.YELLOW}[3] - Token Information         {Fore.RED}║ {Fore.YELLOW}[9] - Delete Given Webhook       {Fore.RED}║
       {Fore.RED}║ {Fore.YELLOW}[4] - Half Token From UserID    {Fore.RED}║ {Fore.YELLOW}[10] - Generate Nitro Codes      {Fore.RED}║
       {Fore.RED}║ {Fore.YELLOW}[5] - Unverify Account Token    {Fore.RED}║ {Fore.YELLOW}[11] - Generate Tokens           {Fore.RED}║
       {Fore.RED}║ {Fore.YELLOW}[6] - Disable Account Token     {Fore.RED}║ {Fore.YELLOW}[12] - Back To Main Menu.        {Fore.RED}║
      {Fore.RED}[+]═══════════════════════════════[+]════════════════════════════════[+]
...
def credits():
  ...
  print(f'''{Fore.YELLOW}
            ...
            {Fore.RED}[+]═════════════════════════[+]═════════════════════════[+]
            {Fore.RED} ║          {Fore.YELLOW}Made By:        {Fore.RED}║       {Fore.YELLOW}Cuts/Historical      {Fore.RED}║      
            {Fore.RED}[+]═════════════════════════[+]═════════════════════════[+]
  ''')
def mainmenu():
  os.system('cls; clear')
  print(f'''{Fore.YELLOW}
                          ...
                          ╚═══╝╚══╗║╚═══╝╚══╝╚═══╝╚══╝╚═══╝╚╝╚═╝╚══╝╚═══╝╚╝╚╝╚╝
                            ...
                            {Fore.RED}[+]═══════════════════[+]═══════════════════[+]
                             {Fore.RED}║ {Fore.YELLOW}[1] - ACCOUNT NUKER {Fore.RED}║ {Fore.YELLOW}[3] - MULTITOOL     {Fore.RED}║
                             {Fore.RED}║ {Fore.YELLOW}[2] - SERVER NUKER  {Fore.RED}║ {Fore.YELLOW}[4] - CREDITS       {Fore.RED}║
                            {Fore.RED}[+]═══════════════════[+]═══════════════════[+]
